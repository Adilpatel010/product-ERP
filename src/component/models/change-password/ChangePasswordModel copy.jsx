...
//             if (result?.logout) {
//                 toast.success(result?.message || "Password changed. Please login again");
//                 onClose();
...
//             {/* MODAL */}
//             <div
//                 className={`relative bg-white w-full max-w-lg rounded-2xl ${closing ? "scale-out" : "scale-in"
//                     }`}
//             >
//                 {/* HEADER */}
...
//                             type="button"
//                             onClick={handleClose}
//                             className="w-1/2 px-6 py-2 text-secondary cursor-pointer rounded-lg border-2 border-gray-300 text-sm font-semibold hover:bg-gray-50"
//                         >
//                             Cancel
//                         </button>
